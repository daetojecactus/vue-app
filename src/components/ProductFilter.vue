      ...
      <aside class="filter">
        ...
        <form class="filter__form form" action="#" method="get" @submit.prevent="submit">
          ...
          <fieldset class="form__block">
            ...
            <ColorsList elementName="filters" :colors="colors" :current-color.sync="currentColorId"/>
...
export default {
  ...
  computed: {
    categories() {
      return this.categoriesData ? this.categoriesData.items : []; //Проверяем, если существует (?), то выводим categoriesData, если нет то выводим пустой массив :[]
    },
    colors() {
