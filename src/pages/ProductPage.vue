        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              ...
              <CartCounter v-model.number="productAmount"/>
            ...
            <figure v-show="productAddSending" style="display: flex;">
                <img width="25px" height="25px" src="/img/loading.gif"/>
                <figcaption>Добавляем товар в корзину...</figcaption>
            </figure>
